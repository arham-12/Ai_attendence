                    ...
                    <div class="relative flex flex-col h-full">
                        ...
                        <div>
                            ...
                            <ul class="space-y-4 px-2 flex-1">
                                ...
                                <li>
                                    <Link to = '/users-analytics' class="text-[#333] text-sm flex items-center hover:text-primary transition-all">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 mr-4"
                                            viewBox="0 0 512 512">
                                            <path
                        ...
                        <div class="flex-1">
                            ...
                            <ul class="space-y-4 px-2 flex-1">
                                ...
                                <li>
                                    <a href="javascript:void(0)" className="text-[#333] text-sm flex items-center hover:text-primary transition-all">
